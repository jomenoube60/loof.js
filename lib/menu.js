    ...
    draw(dt, delta) {
        ...
        for (i = 0; i < this.choices.length; i++) {
            if (this.selected == i) {
                ...
                app.display.blit(this.unselected_pics[i], x, y, {opacity: globalAlpha * (1 - factor)})
                app.display.blit(this.selected_pics[i], x, y, {opacity: globalAlpha * factor})
            } else {
