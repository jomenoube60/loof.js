export class Display {
    constructor(canvas = "#game") {
        ...
        this.context.font = "28px FreeSans"
    ...
    progress(progress, total, x, y, {height=16, fg='rgba(255, 255, 255, 0.9)', bg='black', edge=2}) {
        this.context.save()
        this.context.fillStyle = 'rgba(0, 0, 0, 0.5)'
        this.context.fillRect(x-edge, y-edge, total+(2*edge), height+(2*edge))
        this.context.fillStyle = bg
        this.context.fillRect(x, y, total, height)
        this.context.fillStyle = fg
        this.context.fillRect(x, y, progress, height)
        this.context.restore()
    }
    text(text, x, y) {
        this.context.fillText(text, x || 10, y || 40)
        this.context.strokeText(text, x || 10, y || 40)
    }
    clear() {
